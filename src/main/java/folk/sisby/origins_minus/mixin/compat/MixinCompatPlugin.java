package folk.sisby.origins_minus.mixin.compat;
...
public class MixinCompatPlugin implements IMixinConfigPlugin {
	...
	public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
		if (mixinClassName.startsWith("folk.sisby.origins_minus.mixin.compat.")) {
			LoggerFactory.getLogger("OriginsMinus").info("CHECK MIXIN" + mixinClassName);
